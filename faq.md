...
| Payment cannot be cancelled | Reference `acme-shop-123-order123abc` cannot be cancelled. Invalid state: `something-something`. | See [Cancellations](https://developer.vippsmobilepay.com/docs/vipps-developers/common-topics/cancel/). |
